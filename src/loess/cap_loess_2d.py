...
#
# CALLING EXAMPLE:
#       zout, wout = loess_2d(x, y, z, frac=0.5, degree=1, rescale=False)
#
# INPUT PARAMETERS:
#   X, Y, Z: vectors of equal number of elements containing the coordinates
#       (X,Y) and the corresponding function values Z to be smoothed.
#   ZOUT: vector of smoothed Z values (same size as Z).
#   WOUT: vector of biweights used in the fit (same size as Z).
#
# KEYWORDS:
